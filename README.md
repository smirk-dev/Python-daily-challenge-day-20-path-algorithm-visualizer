...
🚀 **A* vs Dijkstra - A Side-by-Side Comparison** 🚀  

This project is an interactive **Pathfinding Algorithm Visualizer** built using **Python and Pygame**. It visually demonstrates how **A* (A-Star) Search Algorithm** and **Dijkstra's Algorithm** work by solving a randomly generated maze in parallel.

---

## **🔹 Features**
✅ **Dual Algorithm Execution** - A* and Dijkstra run side by side for direct comparison.  
✅ **Interactive UI** - Clickable buttons for generating mazes, running algorithms, and clearing paths.  
✅ **Smooth Animations** - Nodes are visited dynamically for better visualization.  
✅ **Maze Generation** - Automatically generates obstacles for diverse pathfinding challenges.  
✅ **Customizable Grid** - Modify the grid size and algorithm parameters for experimentation.  

---

## **📌 How It Works**
1. **Maze Generation** - Click the **"Generate Maze"** button to create a random obstacle-filled grid.  
2. **Run Pathfinding** - Click the **"Start Search"** button to visualize how A* and Dijkstra find the shortest path.  
3. **Clear Paths** - Click the **"Clear Path"** button to reset paths while keeping the walls intact.  
